/*
EEG
Оцифровывает сигнал c сенсора электроэнцефалограммы (electroencephalogram - EEG), подключенного ко входу А0
платы Arduino и отправляет для отображения в программу визуализации от BiTronics, 
скачать ее можно тут: http://www.bitronicslab.com/guide/ 
